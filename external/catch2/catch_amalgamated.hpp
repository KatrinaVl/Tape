...
namespace Catch {
    ...
    //! Used to signal that the remainder of a test_files should be skipped
...
namespace Catch {
    ...
    struct ResultDisposition { enum Flags {
        ...
        ContinueOnFailure = 0x02,   // Failures fail test_files, but execution continues
        FalseTest = 0x04,           // Prefix expression with !
        SuppressFail = 0x08         // Failures are reported but do not fail the test_files
    }; };
...
namespace Catch {
    ...
    struct WarnAbout { enum What {
        Nothing = 0x00,
        //! A test_files case or leaf section did not run any assertions
        NoAssertions = 0x01,
        //! A command line test_files spec matched no test_files cases
        ...
        struct Benchmark {
            ...
            void run() {
                ...
                CATCH_TRY{
                    ...
                    // test_files case is marked as failed.
...
namespace Catch {
    ...
    private:
        ...
        //! Serializes this test_files spec into a string that would be parsed into
        //! equivalent test_files spec
        void serializeTo( std::ostream& out ) const;
        friend std::ostream& operator<<(std::ostream& out,
                                        TestSpec const& spec) {
...
// Dummy registrator for the dumy test_files case macros
namespace Catch {
    namespace Detail {
        struct DummyUse {
...
namespace Catch {
    ...
    /**
     * Various metadata about the test_files case.
     *
     * A test_files case is uniquely identified by its (class)name and tags
    ...
    struct TestCaseInfo : Detail::NonCopyable {
        ...
        // Adds the tag(s) with test_files's filename (for the -# flag)
        void addFilenameTag();
    ...
    /**
     * Wrapper over the test_files case information and the test_files case invoker
     *
...
namespace Catch {
    ...
    //! stdout/stderr during test_files execution, and pass them to the reporter.
    ...
    protected:
        ...
        //! The test_files run's config as filled in from CLI and defaults
    ...
    public:
        ...
        //! Called when no test_files cases match provided test_files spec
        virtual void noMatchingTestCases( StringRef unmatchedSpec ) = 0;
        //! Called for all invalid test_files specs from the cli
        ...
        /**
         * Called with test_files cases that are skipped due to the test_files run aborting.
         * NOT called for test_files cases that are explicitly skipped using the `SKIP` macro.
         *
...
namespace Catch {
    ...
    public:
        ...
        // TODO: this exists only for adding filenames to test_files cases -- let's expose this in a saner way later
...
namespace Catch {
    ...
    private:
        ...
        // Adds the current pattern as a test_files name
        void addNamePattern();
...
namespace Catch {
    ...
    public:
         ...
         *
         * Should look roughly like the test_files listing in v2 and earlier versions
         * of Catch2. Especially supports low-verbosity listing that mimics the
         * old `--list-test_files-names-only` output.
         */
...
namespace Catch {
    ...
    protected:
        TestRunInfo currentTestRunInfo{ "test_files run has not started yet"_sr };
        TestCaseInfo const* currentTestCaseInfo = nullptr;

        //! Stack of all _active_ sections in the _current_ test_files case
...
namespace Catch {
    ...
    public:
        ...
        static std::string getDescription() {
            using namespace std::string_literals;
            return "Reports test_files results in the format of Automake .trs files"s;
        }
...
namespace Catch {
     ...
     *
     * It stores tree of all test_files cases, sections and assertions, and after the
     * test_files run is finished, calls into `testRunEndedCumulative` to pass the
    ...
    public:
        ...
        //! Customization point: called after last test_files finishes (testRunEnded has been handled)
    ...
    protected:
        ...
        //! The root node of the test_files run tree.
    ...
    private:
        ...
        // Root section of the _current_ test_files case
        Detail::unique_ptr<SectionNode> m_rootSection;
        // Deepest section of the _current_ test_files case
        SectionNode* m_deepestSection = nullptr;
        // Stack of _active_ sections in the _current_ test_files case
...
namespace Catch {
    ...
    //! Should the reporter show duration of test_files given current configuration?
    ...
    /**
     * Lists test_files case information to the provided stream in user-friendly
     * format
     *
     * Used as the default listing implementation by the first party reporter
     ...
     * `--list-test_files-names-only` option, for people who used it in integrations.
     */
    ...
    /**
     * Prints test_files run totals to the provided stream in user-friendly format
     *
...
namespace Catch {
    ...
    public:
        ...
        static std::string getDescription() {
            using namespace std::string_literals;
            return "Reports test_files results in the Generic Test Data SonarQube XML format"s;
        }
...
namespace Catch {
    ...
    public:
        ...
        static std::string getDescription() {
            using namespace std::string_literals;
            return "Reports test_files results in TAP format, suitable for test_files harnesses"s;
        }
...
namespace Catch {
    ...
    public:
        ...
        static std::string getDescription() {
            using namespace std::string_literals;
            return "Reports test_files results as TeamCity service messages"s;
        }
